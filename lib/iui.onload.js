/*
   ...
   when onload.js is included in html page, fireEvent() will be called each time a new "screen" is loaded in app
...
{
  onScreenLoad(e.target.id);
	//console.log("fireEvent - type: " + e.type + ", target: " + e.target.tagName + ", id: " + e.target.id);
}
