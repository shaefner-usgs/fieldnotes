...
addEventListener("click", function(event)
{
	...
	if (link)
	{
		var nofollow = hasClass(link, 'nofollow'); // SAH: added flag for iUI to ignore certain links
		...
		else if (!link.target && link.href && !nofollow) // SAH: added flag for iUI to ignore certain links
		{
...
function encodeForm(form)
{
    ...
    args_global = args; // SAH: copy args to global var to access form values submitted via Ajax on return page
    return args;	  
}
